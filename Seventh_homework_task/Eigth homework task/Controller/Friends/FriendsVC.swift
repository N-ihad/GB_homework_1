...
class FriendsVC: UIViewController {
    ...
    var friends: [User] = [User(name: "Sarah Clark", avatar: UIImage(named: "testAvatar")!),
                           User(name: "Jakaria Joe", avatar: UIImage(named: "testAvatar1")!),
                           User(name: "Lock Json", avatar: UIImage(named: "testAvatar2")!)]
...
extension FriendsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let friendCellDetailsCollectionVC = FriendCellDetailsCollectionVC()
